...
foreign import ccall unsafe "Z3_fixedpoint_get_refutation"
    z3_fixedpoint_get_refutation :: Ptr Z3_context -> Ptr Z3_fixedpoint -> IO (Ptr Z3_model)

foreign import ccall unsafe "Z3_fixedpoint_display_certificate"
    z3_fixedpoint_display_certificate :: Ptr Z3_context -> Ptr Z3_fixedpoint -> IO ()

foreign import ccall unsafe "Z3_fixedpoint_get_model"
